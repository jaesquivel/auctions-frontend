...
export default function AssetsPage() {
  ...
  const columns: ColumnDef<AssetListItem>[] = [
    ...
    { id: 'firstAuctionBase', header: t('columns.firstBase'), width: 150, align: 'right', filterable: true, filterType: 'number', accessorFn: (row) => formatCurrency(row.firstAuctionBase) },
    ...
    { id: 'secondAuctionBase', header: t('columns.secondBase'), width: 150, align: 'right', filterable: true, filterType: 'number', accessorFn: (row) => formatCurrency(row.secondAuctionBase) },
    ...
    { id: 'thirdAuctionBase', header: t('columns.thirdBase'), width: 150, align: 'right', filterable: true, filterType: 'number', accessorFn: (row) => formatCurrency(row.thirdAuctionBase) },
